    ...
    class DangerConfirmationDialog < Primer::Component
      ...
      renders_one :additional_content, lambda { |**system_arguments|
        ...
        system_arguments[:classes] = class_names(
          ...
          "DangerConfirmationDialog-additionalContent"
        )
      ...
      def initialize(
        ...
        **system_arguments
        ...
        @form_arguments[:tag] = "form"

        @form_wrapper = Primer::ConditionalWrapper.new(condition: form_arguments.any?, **@form_arguments)
