...
class PrimerOpenProjectTableHeadTest < Minitest::Test
  include Primer::ComponentTestHelpers
  include ActionView::Helpers::TagHelper

  def render_component(**kwargs, &block)
    render_inline(Primer::OpenProject::Table::Head.new(**kwargs), &block)
  ...
  def test_renders_thead_and_row_with_slots
    render_component do |thead|
  ...
  def test_renders_thead_and_row_with_content
    render_component do
      tag.tr
    end
