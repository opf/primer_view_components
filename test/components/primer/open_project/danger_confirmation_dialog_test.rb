...
class PrimerOpenProjectDangerConfirmationDialogTest < Minitest::Test
  ...
  def test_renders_additional_content
    render_inline(Primer::OpenProject::DangerConfirmationDialog.new) do |dialog|
      ...
      dialog.with_additional_content { "Additional important information." }
    end

    assert_selector("dialog.DangerConfirmationDialog") do
      assert_selector(".DangerConfirmationDialog-additionalContent", text: "Additional important information.")
    end
  end
end
