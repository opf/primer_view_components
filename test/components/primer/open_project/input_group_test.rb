...
class PrimerOpenProjectInputGroupTest < Minitest::Test
  ...
  def test_renders_validation_message_outside_flex_row
    ...
    assert_selector(".InputGroup > .FormControl-inlineValidation", text: "Custom validation message")
    assert_selector(".FormControl-input[aria-invalid]")
    assert_selector(".FormControl .FormControl-inlineValidation[hidden]", visible: :hidden)
  end
  ...
  def test_does_not_render_caption_from_system_argument
    ...
    refute_selector(".FormControl-caption")
  end
end
